...
[实验性 Agent Teams](subsystems/agent-team.zh.md) 在可继续 subagent 之上添加显式启用的持久 roster、任务板和 mailbox。

[外部控制器](../.agents/notes/implemented/architecture/2026-09-20-external-controller-ownership.zh.md)拥有结果；DSH 拥有执行事实。
